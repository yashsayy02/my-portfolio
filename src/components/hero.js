        ...
        <section className="relative w-full h-screen mx-auto">
            <div className='sm:px-16 px-6 absolute flex flex-row top-[120px] items-start gap-5 max-w-7xl'>
                ...
                <div>
                    ...
                    <p className='text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]'>A passionate Full-Stack Web Developer based in Ghaziabad, India</p>
                </div>
            </div>
            {/* <ComputersCanvas /> */}
